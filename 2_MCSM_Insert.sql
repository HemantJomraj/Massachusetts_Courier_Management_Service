...
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('21', 'Meghan Terrace', 'Delayed', '427', '251', '187', '180', '105', '152', '01226', '1010', '2005', '105' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('13', 'Jason Lane', 'Order Placed', '432', '251', '190', '179', '111', '151', '01031', '1011', '2001', '101' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('16', 'Liu Place', 'Dispatched', '429', '251', '190', '182', '111', '153', '01824', '1012', '2001', '101' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('12', 'Princeton Road', 'Cancelled', '430', '250', '182', '179', '109', '153', '01031', '1013', '2009', '109' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('19', 'Park Road', 'Order Placed', '431', '251', '188', '178', '106', '150', '01199', '1014', '2006', '106' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('17', 'Clemsen Road', 'Delayed', '427', '250', '196', '178', '119', '152', '01199', '1015', '2009', '109' )
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('12', 'Tram Road', 'Cancelled', '426', '250', '187', '178', '105', '151', '01199', '1016', '2005', '105')
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('22', 'Carter Road', 'Delayed', '425', '250', '188', '193', '106', '153', '01031', '1017', '2006', '106')
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('21', 'Temple Place', 'In-Transit', '431', '251', '180', '179', '104', '150', '01031', '1018', '2004', '104')
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('18', 'Northampton Street', 'Delayed', '432', '251', '176', '183', '101', '151', '01360', '1019', '2001', '101')
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('18', 'Washington Street', 'In-Transit', '425', '250', '187', '176', '105', '152', '02254', '1020', '2005', '105')
INSERT INTO Package
    (Package_Weight, Last_Updated_Location, Delivery_Status, Package_Type_ID, Delivery_Mode_ID, Origin_Address_ID, Destination_Address_ID, Customer_ID, Priority_ID, Service_Location_Zipcode, Shipment_ID, Warehouse_ID, Office_ID )
VALUES
    ('10', 'Southampton Street', 'Cancelled', '429', '250', '187', '180', '105', '153', '01226', '1021', '2005', '105')
--Select * from Package
